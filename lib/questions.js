...
export const isIconDisplay = (demoId) => {
    const iconDisplays = [demoIds.DICE_ADD_1, demoIds.DICE_LARGER_1, demoIds.LARGER_1, demoIds.LARGER_2, demoIds.LARGER_3, demoIds.WORDS_1, demoIds.CHESS_1, demoIds.PATTERNS_1];
